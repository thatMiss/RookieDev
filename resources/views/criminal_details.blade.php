      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8">
          <div class="left-content">
            <p>An official website of the <em>United States</em> government. </p>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <div class="date">
                    <h6>Nov <span>Time </span></h6>
                  </div>
                  <a href="meeting-details.html"><img src="assets/images/single-meeting.jpg" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="meeting-details.html"><h4>NAME SURNAME</h4></a>
                  <p>Additional Information</p>
                  <p class="description">
					Information Here
                    
                    <br><br>Information Here (2)
                  </p>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="hours">
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="meetings.html">Back To Wanted List</a>
              </div>
            </div>
          </div>
        </div>
